...
export function createFactExtractionChain({
        ...
        functions: [
            {
                ...
                description: "Extracts facts, preferences, goals, or struggles from a student conversation.",
    ...
    const chain = prompt
        .pipe(extractionLlm)
        .pipe(new JsonOutputFunctionsParser()); // Parses the function call output
