...
export function CoreMemoryDashboard() {
  ...
  const handleEditMemory = () => {
    if (editingMemory && editingMemory.content.trim()) {
      setMemories(
        memories.map(mem => (mem.id === editingMemory.id ? editingMemory : mem))
      )
    ...
    <div className="space-y-6">
          ...
          <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Enter the information you want Mem0 to remember.
                </DialogDescription>
              </DialogHeader>
              <Textarea
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Control what Mem0 is allowed to remember
            </CardDescription>
          </CardHeader>
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-muted-foreground text-sm">
                  Store code patterns and preferences
                </p>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Badge variant="secondary">
                  {memories.filter(m => m.type === "coding-preference").length}
                </Badge>
              </div>
              <Separator />
              <div className="flex items-center justify-between">
                ...
                <Badge variant="secondary">
                  {memories.filter(m => m.type === "user-preference").length}
                </Badge>
              </div>
              <Separator />
              <div className="flex items-center justify-between">
                ...
                <Badge variant="secondary">
                  {memories.filter(m => m.type === "project-data").length}
                </Badge>
              </div>
              <Separator />
              <div className="flex items-center justify-between">
                ...
                <Badge variant="secondary">
                  {memories.filter(m => m.type === "manual-entry").length}
                </Badge>
              </div>
            </div>
          </CardContent>
      ...
      <Tabs defaultValue="all" className="w-full">
            ...
            {filteredMemories.length > 0 ? (
              filteredMemories.map(memory => (
                <Card key={memory.id} className="relative">
                  <CardHeader className="pb-2">
                    <div className="flex justify-between">
                      ...
                      <div className="flex gap-2">
                        <Dialog
                          open={
                            isEditDialogOpen && editingMemory?.id === memory.id
                          }
                          onOpenChange={open =>
                        ...
                        >
                          ...
                          <DialogContent>
                            <DialogHeader>
                              ...
                              <DialogDescription>
                                Update this memory&apos;s content or details.
                              </DialogDescription>
                            </DialogHeader>
                            {editingMemory && (
                              <>
                                ...
                                >
                                  ...
                                  <SelectContent>
                                    <SelectItem value="coding-preference">
                                      Coding Preference
                                    </SelectItem>
                                    <SelectItem value="user-preference">
                                      User Preference
                                    </SelectItem>
                                    <SelectItem value="project-data">
                                      Project Data
                                    </SelectItem>
                                    <SelectItem value="communication-style">
                                      Communication Style
                                    </SelectItem>
                        ...
                        <Dialog
                          open={
                            isDeleteDialogOpen && memoryToDelete === memory.id
                          }
                          onOpenChange={open =>
                  ...
                  <CardFooter className="text-muted-foreground flex justify-between pt-2 text-xs">
                    ...
                    <span>
                      {new Date(memory.date).toLocaleDateString()} • Relevance:{" "}
              ...
              <div className="py-10 text-center">
                <p className="text-muted-foreground">
                  No memories found. Add some using the button above.
                </p>
              </div>
            )}
          </div>
        ...
        <TabsContent value="coding" className="mt-4">
          <div className="space-y-4">
            {filteredMemories.filter(m => m.type === "coding-preference")
              .length > 0 ? (
              filteredMemories
                  ...
                  <Card key={memory.id}>
                    ...
                    <CardFooter className="text-muted-foreground flex justify-between pt-2 text-xs">
                      ...
                      <span>
                        ...
                        Relevance: {memory.relevance.toFixed(2)}
                      </span>
                    </CardFooter>
                  </Card>
                ))
        ...
        <TabsContent value="user" className="mt-4">
          <div className="space-y-4">
            {filteredMemories.filter(m => m.type === "user-preference").length >
            0 ? (
              filteredMemories
        ...
        <TabsContent value="project" className="mt-4">
          <div className="space-y-4">
            {filteredMemories.filter(m => m.type === "project-data").length >
            0 ? (
              filteredMemories
