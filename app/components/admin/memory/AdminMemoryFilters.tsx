...
export const AdminMemoryFilters: React.FC<AdminMemoryFiltersProps> = ({
  ...
  }, [selectedFactTypes, includeInactive, fromDate, toDate, minConfidence, onFilterChange]);
  ...
  return (
    <div className="mb-6 space-y-4 rounded border bg-gray-50 p-4">
      ...
      {/* Search Input */}
      <div>
        <label htmlFor="admin-memory-search" className="mb-1 block text-sm font-medium text-gray-700">
          Search Content
        </label>
        <input
      ...
      {availableFactTypes.length > 0 && (
        <div>
          <h4 className="mb-2 text-sm font-medium text-gray-700">Filter by Type</h4>
      ...
      <div className="grid grid-cols-1 items-end gap-4 md:grid-cols-3">
        ...
        {/* Confidence Filter */}
        <div>
          <label htmlFor="min-confidence" className="mb-1 block text-sm font-medium text-gray-700">
             Min. Confidence (0-1)
          </label>
          <input 
            id="min-confidence" 
