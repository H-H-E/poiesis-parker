...
import type { Fact, FeedbackType, SearchParams } from '@/app/components/student/memory/types';
...
export default function StudentMemoryPage() {
  ...
  const fetchFacts = useCallback(async () => {
    ...
    try {
      ...
      if (availableFactTypes.length === 0 && data.facts && data.facts.length > 0) {
  ...
  const handleFeedback = async (factId: string, feedbackType: FeedbackType): Promise<void> => {
    try {
      ...
      <div className="mx-auto max-w-4xl">
        <header className="mb-8">
          ...
          <p className="text-gray-600">
            Here's what I understand about you from our interactions. 
            This helps me provide a more personalized learning experience.
          </p>
        </header>
        ...
        <footer className="mt-12 border-t border-gray-200 pt-6 text-center text-sm text-gray-500">
          <p>
            Your privacy is important. This information is used solely to personalize your learning experience.
          </p>
        </footer>
      </div>
    </main>
